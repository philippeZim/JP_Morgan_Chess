...
import _root_.cController.ControllerComponent.DuoChessController
...
class ControllerSpec extends AnyWordSpec with Matchers {
    ...
    "A Controller" should {
        "play a move" in {
            ...
            val controller = new Controller(new RealChessFacade, new XMLApi, startingFen, new ChessContext(), "")
            ...
            val controller2 = new Controller(new RealChessFacade, new XMLApi, possiblePromoSoon, new ChessContext(), "")
        ...
        "detects a white win" in {
            ...
            val controller = new Controller(new RealChessFacade, new XMLApi, mattFen1, new ChessContext(), "")
            controller.play(ChessBoard.moveToIndex("f5", "f6"))
        ...
        "detects a black win" in {
            ...
            val controller = new Controller(new RealChessFacade, new XMLApi, mattFen2, new ChessContext(), "")
            controller.play(ChessBoard.moveToIndex("f5", "f6"))
        ...
        "detect a Remis" in {
            ...
            val controller = new Controller(new RealChessFacade, new XMLApi, remisFen, new ChessContext(), "")
        ...
        "detect a possible Promotion and ringObservers" in {
            ...
            val controller = new Controller(new RealChessFacade, new XMLApi, promotionFen, new ChessContext(), "")
        ...
        "outsource promoting a pawn correctly" in {
            ...
            val testController = new Controller(new RealChessFacade, new XMLApi, promotionFen, new ChessContext, " ")
        ...
        "return correct outputs based on the game state" in {
            val controller = new Controller( new RealChessFacade, new XMLApi, "rnbqkbnr/ppppp2p/5p2/6pQ/4P3/3P4/PPP2PPP/RNB1KBNR b KQkq - 1 3", new ChessContext(), "")
            controller.play(7,15)
            controller.output should be ("Schwarz wurde vernichtend geschlagen")

            val controller2 = new Controller(new RealChessFacade, new XMLApi, "rnb1kbnr/pppp1ppp/8/4p3/5PPq/8/PPPPP2P/RNBQKBNR w KQkq - 1 3", new ChessContext(), "")
            controller2.play(59, 8)
            controller2.output should be ("Weiß wurde vernichtend geschlagen")

            val controller3 = new Controller(new RealChessFacade, new XMLApi, "8/8/8/8/8/1q1k4/8/K7 w - - 0 1", new ChessContext(), "")
        ...
        "promote correctly" in {
            val controller = new Controller(new RealChessFacade, new XMLApi, "rPbqkbnr/1pppppp1/8/8/8/8/P1PPPPpP/RNBQKBNR w KQkq - 0 5", new ChessContext(), "")
            controller.promotePawn("Q")
            controller.fen should be (new RealChessFacade, new XMLApi, "rqbqkbnr/1pppppp1/8/8/8/8/P1PPPPpP/RNBQKBNR w KQkq - 0 5")

            val controller2 = new Controller(new RealChessFacade, new XMLApi, "rnbqkbnr/Ppppppp1/8/8/8/8/P1PPPPpP/RNBQKBNR w KQkq - 0 5", new ChessContext(), "")
            controller2.play(8,1)
            controller2.fen should be (new RealChessFacade, new XMLApi, "rPbqkbnr/1pppppp1/8/8/8/8/P1PPPPpP/RNBQKBNR b KQkq - 0 5")
        }
